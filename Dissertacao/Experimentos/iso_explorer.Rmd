---
title: "Reproduzindo analises de isC3topos"
author: "Felipe"
date: "25/02/2022"
...
Separando dados do Norte do Chile (_NC#o serC#o utilizados_)
```{r}
#dat.chile<-dat.both %>% filter(Region%in%c("North Chile Coast","North Chile")) - NCO SERC USADO
```
...
Buscando adicionar o rank de intensidade de violC*ncia por sC-tio
```{r}
