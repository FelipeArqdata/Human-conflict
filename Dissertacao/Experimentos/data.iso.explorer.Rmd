...
View(data_isoperu)
```
Checando normalidade nos dados 
...
Realizando teste de normalidade de Shapiro-Wilk
```{r}
...
```{r}
dat.correl <- data_isoperu %>% select(C.b.coll.,N.b.coll.,Temp_Mean,Precip_Mean,Temp_Mean_Seasonality,Precip_Mean_Seasonality,Demography)
