...
Dando seguimento a análise. Agora utilizando um dataset que contémm somente dados da região centro-sul do Peru que foi previamente preparado 
...
par(mfrow = c(2,2))
hist(data_C$med.date, xlab = "yBP", ylab = "N.Individuos", main = "", xlim = c(0,2000))# limitando o eixo X atpe 2000 anos
mtext ("todos os individuos (n=833)", cex = 0.75)
